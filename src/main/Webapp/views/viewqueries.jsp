...
try
{
	...
	PreparedStatement pstmt = con.prepareStatement("select * from queries_table");
...
<html>
<head>
<title>View Queries</title><meta charset="UTF-8">
...
<br><br><br>
<h2 align="center">View User Queries</h2>
...
<% 
	...
	out.println("<td align=center><a href='/reply/"+rs.getString(3)+"'>Accept</a></td>");
	out.println("<td align=center><a href='/deletequery/"+rs.getInt(1)+"'>Reject</a></td>");
	out.println("</tr>");
	}
	out.println("</table>");
