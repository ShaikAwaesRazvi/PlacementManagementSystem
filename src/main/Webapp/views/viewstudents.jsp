...
try
{
	...
	PreparedStatement pstmt = con.prepareStatement("select * from Student_table");
...
<html>
<head>
<title>View Students</title><meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/boxicons@latest/css/boxicons.min.css">
    <link rel="stylesheet" href="viewstudents.css" type="text/css" />
</head>
...
<% 
	...
	out.println("<table align=center width=900px height=150px border='1'>");
	%></center><%
	...
	out.println("<td align=center>"+rs.getString(7)+" "+rs.getString(12)+"</td>");
	out.println("<td align=center>"+rs.getInt(24)+"</td>");
	out.println("<td align=center>"+rs.getString(5)+"</td>");
	out.println("<td align=center>"+rs.getString(4)+"</td>");
	out.println("<td align=center><a href='/updatestudent/"+rs.getInt(1)+"'>UPDATE</a></td>");
	out.println("<td align=center><a href='/deletestudent/"+rs.getInt(1)+"'>DELETE</a></td>");
	out.println("</tr>");
	}
	out.println("</table>");
