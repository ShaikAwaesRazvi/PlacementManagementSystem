...
try
{
	...
	PreparedStatement pstmt = con.prepareStatement("select * from applied_table where student_id=?");
...
<br><br>
<h2 align="center">Applied Status</h2>
 ...
 <% 
	...
	out.println("<table align=center width=850px height=100px border='1'>");
	%></center><%
