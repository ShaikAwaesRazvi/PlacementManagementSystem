...
<html>
<head>
<title>View Jobs</title><meta charset="UTF-8">
...
<% 
	...
	out.println("<td align=center>"+rs.getDouble(7)+"</td>");
	out.println("<td align=center><a href='/updatejobs/"+rs.getInt(1)+"'>UPDATE</a></td>");
	out.println("<td align=center><a href='/deletejobs/"+rs.getInt(1)+"'>DELETE</a></td>");
	out.println("</tr>");
	}
	out.println("</table>");
