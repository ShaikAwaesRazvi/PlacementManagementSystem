...
<title>Update Backlogs</title><meta charset="UTF-8">
...
<center>
<br><br><br><br><br><br>
	  <form method="POST" action="/updatebacklogs">
	  <fieldset style="width:100px" ;"height:50px"> 
	  <table align=center width=500px height=250px>
	  <h2 align="center"><B>Update Backlogs Details</B></h2>
	  <hr>
	  <tr>
	  <td><b>Student ID :</b>${sid} <br></td>
	    ...
	    <tr>
	  <td><b>Updated Backlogs :</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="backlogs" placeholder="Enter Updated Backlogs" required><br></td>
	  </tr>
	  
	  <tr>
	  <td align =center><input type="submit" value="Change Backlogs"></td>
	  </tr>
