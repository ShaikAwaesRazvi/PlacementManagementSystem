...
<title>Update CGPA</title><meta charset="UTF-8">
...
<br><br><br><br><br><br>
	  ...
	  <td><b>Student ID :</b>${sid} <br></td>
	    ...
	    <tr>
	  <td><b>Updated CGPA :</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="cgpa" placeholder="Enter Updated CGPA" required step="0.1" min="0" max="10"><br></td>
	  </tr>
	  
	  <tr>
	  <td align =center><input type="submit" value="Change CGPA"></td>
	  </tr>
